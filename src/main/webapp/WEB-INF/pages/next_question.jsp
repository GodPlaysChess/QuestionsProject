...
<div id="global-container" class="container">
    <h1 class="text-center">Экзамен</h1>

    <div id="main-container" class="row main-container">
        <div id="center-container" class="span12">
            <textarea disabled="true" name="text" rows="10" class="span12">${question_info.question.text}</textarea>
        </div>
    </div>
    ...
    <form action="/submit_answer.html" method="post">
        ...
        <div id="answer-container" class="span8">
            <textarea name="text" rows="12" class="input-block-level span8"></textarea>
        </div>
